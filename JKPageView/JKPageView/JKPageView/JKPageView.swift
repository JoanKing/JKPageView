...
class JKPageView: UIView {
    var delegate: JKPageViewDelegate?
    /// 标题
    ...
    init(frame: CGRect, titles: [String], childVcs: [UIViewController], parentVc: UIViewController, style: JKTitleStyle) {
